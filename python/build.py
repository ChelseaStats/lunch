...
if(error is False):
    ...
    if __name__ == "__main__":
        ...
        if(chosen_venue.twitter):
            tweet = f"Venue of the day in #Cheltenham is {chosen_venue.name}, see https://cheltenham-open-data.github.io/lunches/ for more info {chosen_venue.twitter} #LunchBot #VofD"
        else:
            tweet = f"Venue of the day in #Cheltenham is {chosen_venue.name}, see https://cheltenham-open-data.github.io/lunches/ for more info #LunchBot #VofD"
        print(tweet)
